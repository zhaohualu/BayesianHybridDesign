...
#' @examples
#' 
#' Frequentist.Analysis.Current.Study.Only(Yt=18, nt=40,Yc=13, nc=40, conflev=0.8)
#' 
#' @export
#' 
Frequentist.Analysis.Current.Study.Only = function(Yt=20, nt=40, Yc=12, nc=40, conflev=0.8){
