#' Plot of Posterior Mean Difference (PMD) Object produced by power.DPP() function.
#'
...
#'
#' @param  o Object produced by power.DPP() function.
#' @param o2 Second object produced by power.DPP() function. Default NULL. 
#'
...
plotPMD = function(o, o2=NULL){
  ...
  if (is.null(o2)) {
    ...
    plot(d, col = "blue", lwd = 2, ylim = c(0, max(d$y)), 
         main = "Posterior Mean ORR Difference", xlab = "ORR Difference (Hybrid control - concurrent control)", ylab = "Density")
